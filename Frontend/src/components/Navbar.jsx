...
import path from '../../../fontend/src/routes/paths'
        ...
        <div className='bg-white py-3 shadow-2xl px-4 md:px-0'>
            <div className='max-w-6xl mx-auto flex justify-between items-center'>
                ...
                <div className='flex gap-7 items-center'>
                    <Link to={'/'}><h1 className='font-bold text-3xl'><span className='text-red-500 font-serif'>H</span>ardeep</h1></Link>
                ...
                <nav className='flex gap-7 items-center'>
                    ...
                    <div className='hidden md:block'>
                        <button onClick={() =>{window.location.href = 'http://localhost:3000/nickelfox/authentication/login'}}
